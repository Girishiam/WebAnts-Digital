        ...
        <main className="min-h-screen bg-deep-void text-starlight-white pt-24 pb-20 px-6 md:px-12 font-inter">
            ...
            <div className="max-w-4xl mx-auto relative z-10">
                ...
                <section className="mb-20">
                    ...
                    <p className="text-xl text-muted-silver leading-relaxed">
                ...
                <section className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-24">
                    <div className="p-8 bg-white/5 border border-white/10 rounded-2xl backdrop-blur-lg">
                ...
                {/* Stats */}
                <section className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-24 border-t border-white/10 pt-12">
                ...
                {/* Call to Action */}
                <section className="text-center py-20 bg-gradient-to-b from-transparent to-ants-blue/10 rounded-3xl border border-white/5">
                    <h2 className="font-monument text-3xl md:text-4xl uppercase mb-6">Ready to Scale?</h2>
                    <p className="text-muted-silver mb-8 max-w-lg mx-auto">
...
function Stat({ number, label }: { number: string, label: string }) {
    return (
        <div className="text-center">
            <div className="font-monument text-3xl md:text-5xl text-transparent bg-clip-text bg-gradient-to-b from-white to-white/50 mb-2">
                {number}
            </div>
